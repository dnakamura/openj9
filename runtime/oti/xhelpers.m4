...
ifdef({METHOD_INVOCATION},{
	...
	dnl J9TR_J9_EXTENDED_RUNTIME2_USE_EXTENDED_VECTOR_REGISTERS marks if we are using AVX-512 (eg ZMM)
	...
	and SR_TEMP_REG_2, J9TR_J9_EXTENDED_RUNTIME2_USE_EXTENDED_VECTOR_REGISTERS
